<?php
/**
 * Plugin Name: PDF Builder for Ninja Forms
...
use rednaoformpdfbuilder\Integration\Adapters\NinjaForms\Loader\NinjaFormsSubLoader;

require_once plugin_dir_path(__FILE__).'autoload.php';
new NinjaFormsSubLoader(__FILE__,array(
    'ItemId'=>382,
    'Author'=>'Edgar Rojas',
    'UpdateURL'=>'https://pdfbuilder.rednao.com',
    'FileGroup'=>'PDFBuilderNinjaForms'
));
